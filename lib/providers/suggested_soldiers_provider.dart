...
class SuggestedSoldiersProvider with ChangeNotifier {
  ...
  fetchSuggestedSoldiers(int sectionId) async {
    final sectionSoldiersDataList =
    await _databaseHelper.getSoldiersBySection(sectionId);
    final existingSoldiersDataList =
    await _databaseHelper.getExistingSoldiersBySection(sectionId);
    final outingSoldiersDataList =
    await _databaseHelper.getOutingSoldiersBySection(sectionId);
